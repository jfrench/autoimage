#' Reset par
#'
#' \code{reset.par} resets the arguments of \code{\link[graphics]{par}}
#' to the default values when first opening R (as of version 3.2.2).
...
reset.par <- function(){
  parlist <- list(xlog = FALSE,
                  ...
                  omi = rep(0, 4),
                  pch = 1,
                  pin = c(4.999583, 3.847500),
                  plt = c(0.1314190, 0.9326878, 0.1793407, 0.8558242),
                  ps = 12,
                  pty = "m",
                  smo = 1,
                  srt = 0,
