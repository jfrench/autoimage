...
#'
#' \code{ptext} draws polygons using the vertices given in \code{x} and
#' \code{y}, possibly with projected coordinates.  
#' 
...
#' @seealso \code{\link[graphics]{polygon}}, \code{\link[mapproj]{mapproject}}, \code{\link[autoimage]{pimage}}
#' @return NULL
#' @examples
#' data(narccap)
