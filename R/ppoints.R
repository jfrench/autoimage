...
#'
#' \code{ppoints} draws a sequence of points for projected coordinates.
#' 
...
#' @seealso \code{\link[graphics]{points}}, \code{\link[mapproj]{mapproject}}, \code{\link[autoimage]{pimage}} 
#' @return NULL
#' @examples
#' data(narccap)
