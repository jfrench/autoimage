#' Color scale legend
#'
#' \code{legend.scale} plots a color gradient with 
#' an associated quantitative scale.
#' 
#' The length of the \code{col} vector indicates the 
#' number of partitions for the quantitative range.
#'
#' @param zlim A two-dimensional vector containing the minimum and maximum 
#' quantitative limits, respectively, for the color scale.
#' @param col A vector of colors used for the color scale.  
#' Typically, this is a gradient of colors. The default is 
#' the 12 colors generated by \code{viridis::viridis(12)}.
#' @param horizontal A logical value indicating whether the legend 
#' should extend horizontally (\code{TRUE}) or vertically (\code{FALSE}).  
#' The default is \code{TRUE}.
#' @param breaks The sequence of values defining the partition of 
#' \code{zlim}.  The length should be one more than then number 
#' of colors.  If not specified, then equidistant breaks are used.
#' @param axis.args A list of named elements corresponding to the 
#' arguments of the \code{\link[graphics]{axis}} function.  This is 
#' used to modify the appearance of the scale of the legend.  See Examples.
#' @references The code for this function is derived from the internals 
#' of the \code{\link[fields]{image.plot}} function written by Doug Nychka 
#' and from the \code{image.scale} function written by Marc Taylor and 
#' discussed at 
